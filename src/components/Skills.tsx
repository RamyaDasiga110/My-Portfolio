  ...
  return (
    <section id="skills" className="w-full py-20 bg-white relative">
      ...
      <div className="absolute top-0 left-0 h-full w-full">
        <svg className="absolute top-10 right-10 h-64 w-64 text-portfolioBlue opacity-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="absolute bottom-10 left-10 h-48 w-48 text-portfolioBlue opacity-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container mx-auto px-4">
        {/* Main heading styled similar to Projects section */}
